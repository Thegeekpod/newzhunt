  ...
  <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 24px; margin-top: 10px;">
        ...
        <label class="form-check">
          <input type="checkbox" name="is_sub_lead" value="1" {{ old('is_sub_lead', $article->is_sub_lead) ? 'checked' : '' }}>
        ...
        <label class="form-check">
          <input type="checkbox" name="is_latest" value="1" {{ old('is_latest', $article->is_latest) ? 'checked' : '' }}>
          <span>Show in Latest (সর্বশেষ সংবাদে দেখান)</span>
        </label>

        <label class="form-check">
          <input type="checkbox" name="is_special_banner" value="1" {{ old('is_special_banner', $article->is_special_banner) ? 'checked' : '' }}>
